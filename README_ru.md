...
| `zcode --reinstall` | **Чистая переустановка:** Полное удаление файлов/конфигов и чистая установка с GitHub |
| `zcode --clean-wipe` | Удаление всех пользовательских настроек, кэша, расширений и авторизаций |
| `zcode --full-delete` | Полное удаление ZCode и всех связанных лаунчеров и файлов |
